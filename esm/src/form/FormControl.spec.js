...
import { ref } from "vue";
import { TestUnit, getCompo, checkValue, triggerEvent, } from "../ServiceTestUtils";
import FormControl from "./FormControl";
const Service = function () {
    return FormControl(ref({ name: "", password: "" }), ref({ name: { required: true, message: "必填" } }));
};
...
//# sourceMappingURL=FormControl.spec.js.map